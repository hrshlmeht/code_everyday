...
#################zigzag pattern string and matrix conversion paypal asked##@#
#
# class Solution:
...
############construct K palindromic strings = Leetcode daily question############
# class Solution:
...
#             if len(path) == len(l):
#                 res.append(
#                     path[:])  # note [:] make a deep copy since otherwise we'd be append the same list over and over
#                 return
#
...
#converting fration to decimal and handling the recurring decimal as well 
